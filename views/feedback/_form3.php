...
<h3><?php echo $subject." &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp For &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp". $faculty; 
//$model->subject_id = $it;
?></h3>
	...
	<?= $form->field($model, 'reg_no')->textInput(['readonly' => true])->label("Enter your Registartion Number"); ?>
