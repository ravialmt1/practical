<div class="form-group" id="add-subjects">
<?php
...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'sub_name' => ['type' => TabularForm::INPUT_TEXT],
        'del' => [
            'type' => 'raw',
            'label' => '',
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowSubjects(' . $key . '); return false;', 'id' => 'subjects-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . 'Add Subjects', ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowSubjects()']),
        ]
    ]
]);
echo  "    </div>\n\n";
