...
<div class="col-xs-12">
                <div class="row">
                    <div class="col-sm-12">
						...
						<h4 class="page-title" align ="center">University : <?= $uni_name ?> </h4><br />  
						<h4 class="page-title" align ="center">Course : <?= $course->course_name ?> </h4><br />  
						<h4 class="page-title" align ="center">Semester:<?= $sem ?> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Section: <?= $section_id ?></h4>
                    </div>
                </div>
