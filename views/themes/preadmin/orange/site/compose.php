...
<head>
    ...
    <title>Ravichandra - Bootstrap Admin Template</title>
                                ...
                                <li class="media notification-message">
                                    <a href="activities.html">
                                        <div class="media-left">
                                            <span class="avatar">
												<img alt="Ravichandra" src="assets/img/user.jpg" class="img-responsive img-circle">
											</span>
                                        </div>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        <li>
                            <a href="inbox.html"><i class="fa fa-home back-icon"></i> Back to Inbox</a>
                        </li>
                        <li>
                        ...
                        <div class="card-box">
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php CKEditorInline::begin(['preset' => 'advanced']);?>
