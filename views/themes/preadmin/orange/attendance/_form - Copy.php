...
<div class="classes-form">
    ...
    'pluginOptions'=>[
        'depends'=>['section-uni_id'],
        'url' => Url::to(['/classes/vertical-sel']),
...
<div class="col-md-3">
 ...
 <?=  $form->field($model, 'subject')->widget(DepDrop::classname(), [
    ...
    'select2Options'=>['pluginOptions'=>['allowClear'=>true]],
    'pluginOptions'=>[
        'depends'=>['section-uni_id','section-course_id','section-semester','section-section'],
