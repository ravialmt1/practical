...
use app\modules\students\models\StudentDetailsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * StudetailsController implements the CRUD actions for StudentDetails model.
 */
class StudetailsController extends Controller
{
    /**
     * @inheritdoc
     */
